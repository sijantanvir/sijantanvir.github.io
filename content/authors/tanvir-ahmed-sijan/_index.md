...
social:
  - icon: envelope
    icon_pack: fas
    link: mailto:sijantanv@gmail.com
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/tanvir-sijan
  - icon: github
    icon_pack: fab
    link: https://github.com/sijantanvir
  - icon: twitter
    icon_pack: fab
...
My research interests lie broadly in Computational Linguistics and Natural Language Processing. I am interested in reverse-engineering the internal causal mechanisms of language models to better understand their behavior, evaluating how they interact with human and cultural contexts, and making them more capable, reliable, and aligned with human values. My recent work spans **cultural alignment**, **event extraction**, and **mechanistic interpretability of LLMs.**
